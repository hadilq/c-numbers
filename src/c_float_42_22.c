...
f4222_t div_f4222(f4222_t a, f4222_t b) {
    ...
    if (sig_b == 0ULL) {
        if (posi_a) {
            ...
            return (((1ULL << (EXPONENT_BITS_F_42_22 - 2)) - 1) << SIGNIFICAND_BITS_F_42_22)
                   | ((1ULL << (SIGNIFICAND_BITS_F_42_22 - 2)) - 1);
        } else {
            // Return min value as "-infinity"
            return (((1ULL << (EXPONENT_BITS_F_42_22 - 2)) - 1) << SIGNIFICAND_BITS_F_42_22)
                   | (SIGNIFICAND_SIGN_MASK_F_42_22);
        }
    }
