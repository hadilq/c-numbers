...
f0610_t div_f0610(f0610_t a, f0610_t b) {
    ...
    if (sig_b == 0U) {
        if (posi_a) {
            ...
            return (((1U << (EXPONENT_BITS_F_06_10 - 2)) - 1) << SIGNIFICAND_BITS_F_06_10)
                   | ((1U << (SIGNIFICAND_BITS_F_06_10 - 2)) - 1);
        } else {
            // Return min value as "-infinity"
            return (((1U << (EXPONENT_BITS_F_06_10 - 2)) - 1) << SIGNIFICAND_BITS_F_06_10)
                   | (SIGNIFICAND_SIGN_MASK_F_06_10);
        }
    }
