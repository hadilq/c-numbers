...
#define SIGNIFICAND_2_MASK_F_57_07 (((__uint128_t)1ULL << 2 * SIGNIFICAND_BITS_F_57_07) - 1)
...
#define BITS_SIGN_MASK_F_57_07 (1ULL << (BITS_F_57_07 - 1))

#define MAX_VALUE_F_57_07 (((1ULL << (EXPONENT_BITS_F_57_07 - 2)) - 1) << SIGNIFICAND_BITS_F_57_07) | ((1ULL << (SIGNIFICAND_BITS_F_57_07 - 2)) - 1)
#define MIN_VALUE_F_57_07 (((1ULL << (EXPONENT_BITS_F_57_07 - 2)) - 1) << SIGNIFICAND_BITS_F_57_07) | (SIGNIFICAND_SIGN_MASK_F_57_07)
