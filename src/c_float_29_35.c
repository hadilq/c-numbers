...
f2935_t div_f2935(f2935_t a, f2935_t b) {
    ...
    if (sig_b == 0ULL) {
        if (posi_a) {
            ...
            return (((1ULL << (EXPONENT_BITS_F_29_35 - 2)) - 1) << SIGNIFICAND_BITS_F_29_35)
                   | ((1ULL << (SIGNIFICAND_BITS_F_29_35 - 2)) - 1);
        } else {
            // Return min value as "-infinity"
            return (((1ULL << (EXPONENT_BITS_F_29_35 - 2)) - 1) << SIGNIFICAND_BITS_F_29_35)
                   | (SIGNIFICAND_SIGN_MASK_F_29_35);
        }
    }
