...
f2341_t div_f2341(f2341_t a, f2341_t b) {
    ...
    if (sig_b == 0ULL) {
        if (posi_a) {
            ...
            return (((1ULL << (EXPONENT_BITS_F_23_41 - 2)) - 1) << SIGNIFICAND_BITS_F_23_41)
                   | ((1ULL << (SIGNIFICAND_BITS_F_23_41 - 2)) - 1);
        } else {
            // Return min value as "-infinity"
            return (((1ULL << (EXPONENT_BITS_F_23_41 - 2)) - 1) << SIGNIFICAND_BITS_F_23_41)
                   | (SIGNIFICAND_SIGN_MASK_F_23_41);
        }
    }
