...
f0214_t new_f0214_from_float16(_Float16 f) {
    ...
    if (SIGNIFICAND_BITS_F_02_14 > Float16_SIG_1) {
        significand <<= SIGNIFICAND_BITS_F_02_14 - Float16_SIG_1;
    } else {
        significand >>= Float16_SIG_1 - SIGNIFICAND_BITS_F_02_14;
    }
    return new_f0214(exponent, significand);
}
...
f0214_t div_f0214(f0214_t a, f0214_t b) {
    ...
    if (sig_b == 0U) {
        if (posi_a) {
            ...
            return MAX_VALUE_F_02_14;
        } else {
            // Return min value as "-infinity"
            return MIN_VALUE_F_02_14;
        }
    }
...
int com_f0214(f0214_t a, f0214_t b) {
    ...
    int16_t exp_a = (a & EXPONENT_MASK_F_02_14) >> SIGNIFICAND_BITS_F_02_14;
    int16_t exp_b = (b & EXPONENT_MASK_F_02_14) >> SIGNIFICAND_BITS_F_02_14;
    int16_t sig_a = a & SIGNIFICAND_MASK_F_02_14;
    int16_t sig_b = b & SIGNIFICAND_MASK_F_02_14;
