...
f5113_t div_f5113(f5113_t a, f5113_t b) {
    ...
    if (sig_b == 0ULL) {
        if (posi_a) {
            ...
            return (((1ULL << (EXPONENT_BITS_F_51_13 - 2)) - 1) << SIGNIFICAND_BITS_F_51_13)
                   | ((1ULL << (SIGNIFICAND_BITS_F_51_13 - 2)) - 1);
        } else {
            // Return min value as "-infinity"
            return (((1ULL << (EXPONENT_BITS_F_51_13 - 2)) - 1) << SIGNIFICAND_BITS_F_51_13)
                   | (SIGNIFICAND_SIGN_MASK_F_51_13);
        }
    }
