...
f4519_t new_f4519(int64_t exp, int64_t sig) {
...
// construct float 4519
f4519_t new_f4519_from_float64(_Float64 f) {
    float64_cast f1 = { .f = f };
    ...
    if (SIGNIFICAND_BITS_F_45_19 > Float64_SIG_1) {
        significand <<= (SIGNIFICAND_BITS_F_45_19 - Float64_SIG_1);
    } else {
        significand >>= Float64_SIG_1 - SIGNIFICAND_BITS_F_45_19;
    }
    return new_f4519(exponent, significand);
...
// construct float 4519
f4519_t new_f4519_from_float32(_Float32 f) {
    float32_cast f1 = { .f = f };
    uint64_t significand = f1.parts.significand;
    uint64_t sign = f1.parts.sign;
    ...
    if (SIGNIFICAND_BITS_F_45_19 > Float32_SIG_1) {
        significand <<= SIGNIFICAND_BITS_F_45_19 - Float32_SIG_1;
    } else {
        significand >>= Float32_SIG_1 - SIGNIFICAND_BITS_F_45_19;
    }
    return new_f4519(exponent, significand);
}
  #endif
...
// construct float 4519
f4519_t new_f4519_from_float16(_Float16 f) {
    float16_cast f1 = { .f = f };
    uint64_t significand = f1.parts.significand;
    ...
    if (SIGNIFICAND_BITS_F_45_19 > Float16_SIG_1) {
        significand <<= SIGNIFICAND_BITS_F_45_19 - Float16_SIG_1;
    } else {
        significand >>= Float16_SIG_1 - SIGNIFICAND_BITS_F_45_19;
    }
    return new_f4519(exponent, significand);
}
  #endif
...
f4519_t div_f4519(f4519_t a, f4519_t b) {
    ...
    if (sig_b == 0ULL) {
        if (posi_a) {
            ...
            return MAX_VALUE_F_45_19;
        } else {
            // Return min value as "-infinity"
            return MIN_VALUE_F_45_19;
        }
    }
...
int com_f4519(f4519_t a, f4519_t b) {
    ...
    int64_t exp_a = (a & EXPONENT_MASK_F_45_19) >> SIGNIFICAND_BITS_F_45_19;
    int64_t exp_b = (b & EXPONENT_MASK_F_45_19) >> SIGNIFICAND_BITS_F_45_19;
    int64_t sig_a = a & SIGNIFICAND_MASK_F_45_19;
    int64_t sig_b = b & SIGNIFICAND_MASK_F_45_19;
