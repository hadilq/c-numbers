...
f1153_t new_f1153_from_float64(_Float64 f) {
    ...
    if (SIGNIFICAND_BITS_F_11_53 > Float64_SIG_1) {
        significand <<= (SIGNIFICAND_BITS_F_11_53 - Float64_SIG_1);
    } else {
        significand >>= Float64_SIG_1 - SIGNIFICAND_BITS_F_11_53;
    }
    return new_f1153(exponent, significand);
...
f1153_t new_f1153_from_float32(_Float32 f) {
    ...
    if (SIGNIFICAND_BITS_F_11_53 > Float32_SIG_1) {
        significand <<= SIGNIFICAND_BITS_F_11_53 - Float32_SIG_1;
    } else {
        significand >>= Float32_SIG_1 - SIGNIFICAND_BITS_F_11_53;
    }
    return new_f1153(exponent, significand);
}
  #endif
...
f1153_t new_f1153_from_float16(_Float16 f) {
    ...
    if (SIGNIFICAND_BITS_F_11_53 > Float16_SIG_1) {
        significand <<= SIGNIFICAND_BITS_F_11_53 - Float16_SIG_1;
    } else {
        significand >>= Float16_SIG_1 - SIGNIFICAND_BITS_F_11_53;
    }
    return new_f1153(exponent, significand);
}
  #endif
...
f1153_t div_f1153(f1153_t a, f1153_t b) {
    ...
    if (sig_b == 0ULL) {
        if (posi_a) {
            ...
            return MAX_VALUE_F_11_53;
        } else {
            // Return min value as "-infinity"
            return MIN_VALUE_F_11_53;
        }
    }
...
int com_f1153(f1153_t a, f1153_t b) {
    ...
    int64_t exp_a = (a & EXPONENT_MASK_F_11_53) >> SIGNIFICAND_BITS_F_11_53;
    int64_t exp_b = (b & EXPONENT_MASK_F_11_53) >> SIGNIFICAND_BITS_F_11_53;
    int64_t sig_a = a & SIGNIFICAND_MASK_F_11_53;
    int64_t sig_b = b & SIGNIFICAND_MASK_F_11_53;
