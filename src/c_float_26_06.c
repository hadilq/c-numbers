...
static uint8_t get_msb_index_positive(uint32_t n) {
    ...
    uint32_t copy = n & SIGNIFICAND_MASK_F_26_06;
...
static uint8_t get_msb_index_64(uint64_t n) {
    ...
    uint64_t copy = n & SIGNIFICAND_2_MASK_F_26_06;
...
f2606_t new_f2606_from_float32(_Float32 f) {
    ...
    if (SIGNIFICAND_BITS_F_26_06 > Float32_SIG_1) {
        significand <<= SIGNIFICAND_BITS_F_26_06 - Float32_SIG_1;
    } else {
        significand >>= Float32_SIG_1 - SIGNIFICAND_BITS_F_26_06;
    }
    return new_f2606(exponent, significand);
}
  #endif
#endif
...
f2606_t new_f2606_from_float16(_Float16 f) {
    ...
    if (SIGNIFICAND_BITS_F_26_06 > Float16_SIG_1) {
        significand <<= SIGNIFICAND_BITS_F_26_06 - Float16_SIG_1;
    } else {
        significand >>= Float16_SIG_1 - SIGNIFICAND_BITS_F_26_06;
    }
    return new_f2606(exponent, significand);
}
  #endif
...
int32_t exp_f2606(f2606_t a) {
    ...
    if ((EXPONENT_SIGN_MASK_F_26_06 & exp_a)) {
...
int32_t sig_f2606(f2606_t a) {
    ...
    if ((SIGNIFICAND_SIGN_MASK_F_26_06 & sig_a)) {
...
f2606_t add_f2606(f2606_t a, f2606_t b) {
    ...
    int32_t exp_a = (a & EXPONENT_MASK_F_26_06) >> SIGNIFICAND_BITS_F_26_06;
    int32_t exp_b = (b & EXPONENT_MASK_F_26_06) >> SIGNIFICAND_BITS_F_26_06;
    uint32_t sig_a = a & SIGNIFICAND_MASK_F_26_06;
    ...
    if ((SIGNIFICAND_SIGN_MASK_F_26_06 & sig_b)) {
    ...
    if ((EXPONENT_SIGN_MASK_F_26_06 & exp_b)) {
    ...
    if (exp_a > exp_b) {
        ...
        if (!posi_b) {
            ...
            if ((sig_b & SIGNIFICAND_MASK_F_26_06) == SIGNIFICAND_MASK_F_26_06) {
                sig_b = 0;
            }
        }
        ...
        if (!posi_a) {
            ...
            if ((sig_a & SIGNIFICAND_MASK_F_26_06) == SIGNIFICAND_MASK_F_26_06) {
                sig_a = 0;
            }
        }
    ...
    if (BITS_SIGN_MASK_F_26_06 & result_sig) {
       posi_result = false;
    }
...
f2606_t div_f2606(f2606_t a, f2606_t b) {
    ...
    if (sig_b == 0U) {
        if (posi_a) {
            ...
            return MAX_VALUE_F_26_06;
        } else {
            // Return min value as "-infinity"
            return MIN_VALUE_F_26_06;
        }
    }

    // Perform division
    uint64_t temp_sig = ((uint64_t)sig_a << SIGNIFICAND_BITS_F_26_06) / sig_b;
...
int com_f2606(f2606_t a, f2606_t b) {
    ...
    int32_t exp_a = (a & EXPONENT_MASK_F_26_06) >> SIGNIFICAND_BITS_F_26_06;
    int32_t exp_b = (b & EXPONENT_MASK_F_26_06) >> SIGNIFICAND_BITS_F_26_06;
    int32_t sig_a = a & SIGNIFICAND_MASK_F_26_06;
    int32_t sig_b = b & SIGNIFICAND_MASK_F_26_06;
