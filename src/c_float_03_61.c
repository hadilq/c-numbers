...
f0361_t new_f0361_from_float64(_Float64 f) {
    ...
    if (SIGNIFICAND_BITS_F_03_61 > Float64_SIG_1) {
        significand <<= (SIGNIFICAND_BITS_F_03_61 - Float64_SIG_1);
    } else {
        significand >>= Float64_SIG_1 - SIGNIFICAND_BITS_F_03_61;
    }
...
f0361_t new_f0361_from_float32(_Float32 f) {
    ...
    if (SIGNIFICAND_BITS_F_03_61 > Float32_SIG_1) {
        significand <<= SIGNIFICAND_BITS_F_03_61 - Float32_SIG_1;
    } else {
        significand >>= Float32_SIG_1 - SIGNIFICAND_BITS_F_03_61;
    }
    return new_f0361(exponent, significand);
}
  #endif
...
f0361_t new_f0361_from_float16(_Float16 f) {
    ...
    if (SIGNIFICAND_BITS_F_03_61 > Float16_SIG_1) {
        significand <<= SIGNIFICAND_BITS_F_03_61 - Float16_SIG_1;
    } else {
        significand >>= Float16_SIG_1 - SIGNIFICAND_BITS_F_03_61;
    }
    return new_f0361(exponent, significand);
}
  #endif
...
f0361_t div_f0361(f0361_t a, f0361_t b) {
    ...
    if (sig_b == 0ULL) {
        if (posi_a) {
            ...
            return MAX_VALUE_F_03_61;
        } else {
            // Return min value as "-infinity"
            return MIN_VALUE_F_03_61;
        }
    }
...
int com_f0361(f0361_t a, f0361_t b) {
    ...
    int64_t exp_a = (a & EXPONENT_MASK_F_03_61) >> SIGNIFICAND_BITS_F_03_61;
    int64_t exp_b = (b & EXPONENT_MASK_F_03_61) >> SIGNIFICAND_BITS_F_03_61;
    int64_t sig_a = a & SIGNIFICAND_MASK_F_03_61;
    int64_t sig_b = b & SIGNIFICAND_MASK_F_03_61;
