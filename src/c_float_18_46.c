...
f1846_t div_f1846(f1846_t a, f1846_t b) {
    ...
    if (sig_b == 0ULL) {
        if (posi_a) {
            ...
            return (((1ULL << (EXPONENT_BITS_F_18_46 - 2)) - 1) << SIGNIFICAND_BITS_F_18_46)
                   | ((1ULL << (SIGNIFICAND_BITS_F_18_46 - 2)) - 1);
        } else {
            // Return min value as "-infinity"
            return (((1ULL << (EXPONENT_BITS_F_18_46 - 2)) - 1) << SIGNIFICAND_BITS_F_18_46)
                   | (SIGNIFICAND_SIGN_MASK_F_18_46);
        }
    }
