...
f4717_t div_f4717(f4717_t a, f4717_t b) {
    ...
    if (sig_b == 0ULL) {
        if (posi_a) {
            ...
            return (((1ULL << (EXPONENT_BITS_F_47_17 - 2)) - 1) << SIGNIFICAND_BITS_F_47_17)
                   | ((1ULL << (SIGNIFICAND_BITS_F_47_17 - 2)) - 1);
        } else {
            // Return min value as "-infinity"
            return (((1ULL << (EXPONENT_BITS_F_47_17 - 2)) - 1) << SIGNIFICAND_BITS_F_47_17)
                   | (SIGNIFICAND_SIGN_MASK_F_47_17);
        }
    }
