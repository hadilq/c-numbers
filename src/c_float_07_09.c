...
f0709_t div_f0709(f0709_t a, f0709_t b) {
    ...
    if (sig_b == 0U) {
        if (posi_a) {
            ...
            return (((1U << (EXPONENT_BITS_F_07_09 - 2)) - 1) << SIGNIFICAND_BITS_F_07_09)
                   | ((1U << (SIGNIFICAND_BITS_F_07_09 - 2)) - 1);
        } else {
            // Return min value as "-infinity"
            return (((1U << (EXPONENT_BITS_F_07_09 - 2)) - 1) << SIGNIFICAND_BITS_F_07_09)
                   | (SIGNIFICAND_SIGN_MASK_F_07_09);
        }
    }
