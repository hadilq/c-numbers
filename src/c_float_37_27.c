...
f3727_t div_f3727(f3727_t a, f3727_t b) {
    ...
    if (sig_b == 0ULL) {
        if (posi_a) {
            ...
            return (((1ULL << (EXPONENT_BITS_F_37_27 - 2)) - 1) << SIGNIFICAND_BITS_F_37_27)
                   | ((1ULL << (SIGNIFICAND_BITS_F_37_27 - 2)) - 1);
        } else {
            // Return min value as "-infinity"
            return (((1ULL << (EXPONENT_BITS_F_37_27 - 2)) - 1) << SIGNIFICAND_BITS_F_37_27)
                   | (SIGNIFICAND_SIGN_MASK_F_37_27);
        }
    }
