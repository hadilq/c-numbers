...
f0230_t new_f0230_from_float32(_Float32 f) {
    ...
    if (SIGNIFICAND_BITS_F_02_30 > Float32_SIG_1) {
        significand <<= SIGNIFICAND_BITS_F_02_30 - Float32_SIG_1;
    } else {
        significand >>= Float32_SIG_1 - SIGNIFICAND_BITS_F_02_30;
    }
    return new_f0230(exponent, significand);
}
...
f0230_t new_f0230_from_float16(_Float16 f) {
    ...
    if (SIGNIFICAND_BITS_F_02_30 > Float16_SIG_1) {
        significand <<= SIGNIFICAND_BITS_F_02_30 - Float16_SIG_1;
    } else {
        significand >>= Float16_SIG_1 - SIGNIFICAND_BITS_F_02_30;
    }
    return new_f0230(exponent, significand);
}
...
f0230_t div_f0230(f0230_t a, f0230_t b) {
    ...
    if (sig_b == 0U) {
        if (posi_a) {
            ...
            return MAX_VALUE_F_02_30;
        } else {
            // Return min value as "-infinity"
            return MIN_VALUE_F_02_30;
        }
    }
...
int com_f0230(f0230_t a, f0230_t b) {
    ...
    int32_t exp_a = (a & EXPONENT_MASK_F_02_30) >> SIGNIFICAND_BITS_F_02_30;
    int32_t exp_b = (b & EXPONENT_MASK_F_02_30) >> SIGNIFICAND_BITS_F_02_30;
    int32_t sig_a = a & SIGNIFICAND_MASK_F_02_30;
    int32_t sig_b = b & SIGNIFICAND_MASK_F_02_30;
