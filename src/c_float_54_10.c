...
f5410_t div_f5410(f5410_t a, f5410_t b) {
    ...
    if (sig_b == 0ULL) {
        if (posi_a) {
            ...
            return (((1ULL << (EXPONENT_BITS_F_54_10 - 2)) - 1) << SIGNIFICAND_BITS_F_54_10)
                   | ((1ULL << (SIGNIFICAND_BITS_F_54_10 - 2)) - 1);
        } else {
            // Return min value as "-infinity"
            return (((1ULL << (EXPONENT_BITS_F_54_10 - 2)) - 1) << SIGNIFICAND_BITS_F_54_10)
                   | (SIGNIFICAND_SIGN_MASK_F_54_10);
        }
    }
