...
f2836_t div_f2836(f2836_t a, f2836_t b) {
    ...
    if (sig_b == 0ULL) {
        if (posi_a) {
            ...
            return (((1ULL << (EXPONENT_BITS_F_28_36 - 2)) - 1) << SIGNIFICAND_BITS_F_28_36)
                   | ((1ULL << (SIGNIFICAND_BITS_F_28_36 - 2)) - 1);
        } else {
            // Return min value as "-infinity"
            return (((1ULL << (EXPONENT_BITS_F_28_36 - 2)) - 1) << SIGNIFICAND_BITS_F_28_36)
                   | (SIGNIFICAND_SIGN_MASK_F_28_36);
        }
    }
