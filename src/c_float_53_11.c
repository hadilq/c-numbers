...
f5311_t div_f5311(f5311_t a, f5311_t b) {
    ...
    if (sig_b == 0ULL) {
        if (posi_a) {
            ...
            return (((1ULL << (EXPONENT_BITS_F_53_11 - 2)) - 1) << SIGNIFICAND_BITS_F_53_11)
                   | ((1ULL << (SIGNIFICAND_BITS_F_53_11 - 2)) - 1);
        } else {
            // Return min value as "-infinity"
            return (((1ULL << (EXPONENT_BITS_F_53_11 - 2)) - 1) << SIGNIFICAND_BITS_F_53_11)
                   | (SIGNIFICAND_SIGN_MASK_F_53_11);
        }
    }
