...
static uint8_t get_msb_index_positive(uint8_t n) {
    ...
    uint8_t copy = n & SIGNIFICAND_MASK_F_CCC_08;
...
static uint8_t get_msb_index_16(uint16_t n) {
    ...
    uint16_t copy = n & SIGNIFICAND_2_MASK_F_CCC_08;
...
fDDD08_t add_fDDD08(fDDD08_t a, fDDD08_t b) {
    ...
    int8_t exp_a = (a & EXPONENT_MASK_F_CCC_08) >> SIGNIFICAND_BITS_F_CCC_08;
    int8_t exp_b = (b & EXPONENT_MASK_F_CCC_08) >> SIGNIFICAND_BITS_F_CCC_08;
    uint8_t sig_a = a & SIGNIFICAND_MASK_F_CCC_08;
    ...
    if (exp_a > exp_b) {
        ...
        if (!posi_b) {
            ...
            if ((sig_b & SIGNIFICAND_MASK_F_CCC_08) == SIGNIFICAND_MASK_F_CCC_08) {
                sig_b = 0;
            }
        }
        ...
        if (!posi_a) {
            ...
            if ((sig_a & SIGNIFICAND_MASK_F_CCC_08) == SIGNIFICAND_MASK_F_CCC_08) {
                sig_a = 0;
            }
        }
    ...
    if (BITS_SIGN_MASK_F_CCC_08 & result_sig) {
       posi_result = false;
    }
...
int com_fDDD08(fDDD08_t a, fDDD08_t b) {
    ...
    int8_t exp_a = (a & EXPONENT_MASK_F_CCC_08) >> SIGNIFICAND_BITS_F_CCC_08;
    int8_t exp_b = (b & EXPONENT_MASK_F_CCC_08) >> SIGNIFICAND_BITS_F_CCC_08;
    int8_t sig_a = a & SIGNIFICAND_MASK_F_CCC_08;
    int8_t sig_b = b & SIGNIFICAND_MASK_F_CCC_08;
